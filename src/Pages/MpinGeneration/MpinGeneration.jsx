...
import MpinGenerationRequest from './Pages/MpinGenerationRequest';

const MpinGeneration = () => {
    ...
    const steps = [
        { label: "Mpin Generation", component: <MpinGenerationRequest /> },
