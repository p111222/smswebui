                                ...
                                <div className="mb-4">
                                    <div className="flex items-center">
                                        ...
                                        {!isFieldDisabled && (
                                            <>
                                                <span className="text-red-500 ml-1">*</span>
                                                <Tooltip title="MPIN must be 4 digits" arrow>
                                                    <InfoOutlinedIcon
                                                        sx={{
                                                            color: "#64748B",
                                                            fontSize: "16px",
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => {
                                            const inputValue = e.target.value;
                                            const digitsOnly = inputValue.replace(/\D/g, '');
                                            const truncatedValue = digitsOnly.slice(0, 4);
                                            setMpin(truncatedValue);
                                        }}
                                        sx={{
                                            "& input::placeholder": { fontSize: "14px" },
                                            backgroundColor: "#F1F4F8",
                                ...
                                <div className="mb-4">
                                    <div className="flex items-center">
                                        ...
                                        {!isFieldDisabled && (
                                            <>
                                                <span className="text-red-500 ml-1">*</span>
                                                <Tooltip title="MPINs must match" arrow>
                                                    <InfoOutlinedIcon
                                                        sx={{
                                                            color: "#64748B",
                                                            fontSize: "16px",
...
export default MpinGenerationRequest