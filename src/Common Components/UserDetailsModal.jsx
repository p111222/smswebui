    ...
    <Dialog
      ...
      PaperProps={{
        sx: {
          borderRadius: '12px',
          boxShadow: '0px 4px 20px rgba(0, 0, 0, 0.1)',
          overflow: 'hidden' // Ensures no inner content bleeds outside rounded corners
        }
      }}
    >
      <DialogTitle className="flex justify-between items-center bg-gradient-to-r from-[rgb(100,15,10)] to-[rgb(180,30,20)] text-white sticky top-0 z-10">
        <Typography variant="h6" fontWeight="medium">User Profile</Typography>
        <IconButton
          onClick={onClose}
          className="!text-white hover:!bg-white/10"
      ...
      <DialogContent className="!p-0 !overflow-y-auto" sx={{
        '&::-webkit-scrollbar': {
